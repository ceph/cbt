...
class Tester():
    ...
    def run(self):
        ...
        # so if there is result like latency, should divide it by the number of
        # client in post_process.
        for thread in self.test_case_tasks:
            res = thread.analyse()
            for key in res:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log',
                        type=str,
                        default = None,
                        help='directory to store logs, no log by default')
